  ...
  return (
    <div className="flex h-screen overflow-hidden bg-gray-50 dark:bg-gray-950">
      ...
      <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
        <header className="shrink-0 border-b border-gray-100 bg-white px-6 py-4 shadow-sm dark:border-gray-800 dark:bg-gray-900">
          <div className="flex items-start justify-between gap-3">
            <div className="flex items-start gap-3">
            <span className="mt-0.5 hidden h-9 w-9 items-center justify-center rounded-lg bg-sky-50 text-sky-700 dark:bg-sky-950 dark:text-sky-300 sm:inline-flex">
          ...
          <section className="mt-8">
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 xl:grid-cols-5">
              {funnel.map((step, index) => (
                <article
                  key={step.key}
                  className="relative rounded-xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800"
                >
                  {index > 0 ? (
                    <div className="mb-3 flex items-center gap-1.5 text-[11px] font-medium text-gray-500 dark:text-gray-400 xl:mb-2">
                      <ChevronRight
                        className="hidden h-3.5 w-3.5 text-gray-300 xl:inline"
                        strokeWidth={2}
                      />
                      <span className="rounded-full bg-gray-50 px-2 py-0.5 tabular-nums text-gray-600 dark:bg-gray-900 dark:text-gray-300">
                  ...
                  <p className="mt-1 text-2xl font-semibold tracking-tight tabular-nums text-gray-900 dark:text-gray-100">
                  ...
                  <tbody className="divide-y divide-gray-100 dark:divide-gray-700">
                    {hotLeads.map((lead) => (
                      <tr
                        ...
                        className="bg-white transition hover:bg-sky-50/60 dark:bg-gray-800 dark:hover:bg-sky-950/40"
                      >
